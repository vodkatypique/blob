...
impl<'a> Configuration<'a> {
    ...
    pub fn battle<T: Strategy, U: Strategy>(&mut self, mut player_one: T, mut player_two: U) -> String {
        ...
        match value {
            x if x > 0 => return String::from("Red"),
            x if x < 0 => return String::from("Blue"),
            _ => return String::from("Draw"),
        }
    }
